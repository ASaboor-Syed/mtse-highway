...
class DivergeEnv(AbstractEnv):
    ...
    def _make_road(self) -> None:
        ...
        net.add_lane("c", "d", SineLane(straight_lanes[0][1].position(ends[1], -amplitude), straight_lanes[0][1].position(sum(ends[:2]), -amplitude),
        ...
        net.add_lane("c", "d", SineLane(straight_lanes[1][1].position(ends[1], amplitude), straight_lanes[1][1].position(sum(ends[:2]), amplitude),
                       -amplitude, np.pi / (ends[1]), np.pi / 2, line_types=[c, c], forbidden=True))
